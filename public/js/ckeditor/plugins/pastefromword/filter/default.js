...
(function() {
    ...
    function x(a, b) {
        var c, d = [];
        a.filterChildren(b);
        for (c = a.children.length - 1; 0 <= c; c--) d.unshift(a.children[c]),
        a.children[c].remove();
        c = a.attributes;
        var f = a,
        e = !0,
        ...
        q = new CKEDITOR.htmlParser.filter({
            ...
            elements: {
                ...
                p: function(a) {
                    ...
                    if (g.thisIsAListItem(b, a)) t.isEdgeListItem(b, a) && t.cleanupEdgeListItem(a),
                ...
                font: function(a) {
                    if (a.getHtml().match(/^\s*$/)) return (new CKEDITOR.htmlParser.text(" ")).insertAfter(a),
                    !1;
                ...
                ul: function(a) {
                    if (c) return "li" == a.parent.name && 0 === n.indexOf(a.parent.children, a) && k.setStyle(a.parent, "list-style-type", "none"),
                    g.dissolveList(a),
                    !1
                },
                li: function(a) {
                ...
                td: function(a) {
                    ...
                    m && k.setStyle(a, "background", m, !0); (c = c["background-color"] || c["BACKGROUND-COLOR"]) && k.setStyle(a, "background-color", c, !0);
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        ...
        createStyleStack: function(a, b, c, d) {
            var f = [];
            a.filterChildren(b);
            for (b = a.children.length - 1; 0 <= b; b--) f.unshift(a.children[b]),
            a.children[b].remove();
            k.sortStyles(a);
            ...
            var e = "span" === a.name,
            h;
            for (h in b) if (!h.match(d || /margin|text\-align|width|border|padding/i)) if (e) e = !1;
            else {
        ...
        inliner: {
            ...
            sort: function(a) {
                return a.sort(function(a) {
                    var c = CKEDITOR.tools.array.map(a,
                    function(a) {
                        return a.selector
                    });
                    return function(a, b) {
            ...
            inline: function(a) {
                ...
                function(a) {
                    ...
                    a = d.find(a.selector);
                    var c, g, r;
                    for (r = 0; r < a.count(); r++) c = a.getItem(r),
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        convertToFakeListItem: function(a, b) {
            ...
            if (!b.attributes["cke-dissolved"]) {
                var c;
                b.forEach(function(a) { ! c && "img" == a.name && a.attributes["cke-ignored"] && "*" == a.attributes.alt && (c = "·", a.remove())
                },
        ...
        removeSymbolText: function(a) {
            ...
            a.forEach(function(d) { ! b && d.value.match(c.replace(")", "\\)").replace("(", "")) && (d.value = d.value.replace(c, ""), d.parent.getHtml().match(/^(\s|&nbsp;)*$/) && (b = d.parent !== a ? d.parent: null))
            },
            CKEDITOR.NODE_TEXT);
            b && b.remove()
        },
        setListSymbol: function(a, b, c) {
            ...
            g.setListSymbol.removeRedundancies(d, c); (a.attributes.style = CKEDITOR.tools.writeCssText(d)) || delete a.attributes.style
        },
        ...
        numbering: {
            toNumber: function(a, b) {
                function c(a) {
                    a = a.toUpperCase();
                    for (var b = 1,
                    c = 1; 0 < a.length; c *= 26) b += "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(a.charAt(a.length - 1)) * c,
                ...
                function d(a) {
                    ...
                    for (var c = b.length,
                    d = 0,
                    g = 0; g < c; ++g) for (var m = b[g], p = m[1].length; a.substr(0, p) == m[1]; a = a.substr(p)) d += m[0];
                    return d
                }
        ...
        calculateValue: function(a) {
            ...
            var c = null,
            d, f, e;
            for (e = a; 0 <= e && null === c; e--) f = b.children[e],
            f.attributes && void 0 !== f.attributes.value && (d = e, c = parseInt(f.attributes.value, 10));
        ...
        dissolveList: function(a) {
            ...
            function(a) {
                ...
                e.forEach(e.filter(a.children, d("li")),
                function(c, d) {
                    var e;
                    switch (g) {
                    case "disc":
            ...
            function(a, b) {
                ...
                if (c && c.name && c.attributes.style && c.attributes.style.match(/mso-list:/i)) {
                    ...
                    delete b["cke-list-level"]; (c = d.display ? "display": d.DISPLAY ? "DISPLAY": "") && k.setStyle(b, "display", d[c], !0)
                }
    ...
    CKEDITOR.plugins.pastefromword.heuristics = {
        ...
        assignListLevels: function(a, b) {
            if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                for (var c = [g.getElementIndentation(b)], d = [b], f = [], e = CKEDITOR.tools.array, h = e.map; b.next && b.next.attributes && !b.next.attributes["cke-list-level"] && t.isDegenerateListItem(a, b.next);) b = b.next,
                c.push(g.getElementIndentation(b)),
                d.push(b);
                var k = h(c,
                function(a, b) {
                    return 0 === b ? 0 : a - c[b - 1]
                }),
                n = this.guessIndentationStep(e.filter(c,
                function(a) {
                    return 0 !== a
                })),
                f = h(c,
        ...
        isShifted: function(a) {
            return "li" !== a.name ? !1 : 0 === CKEDITOR.tools.array.filter(a.children,
            function(a) {
    ...
    g.setListSymbol.removeRedundancies = function(a, b) { (1 === b && "disc" === a["list-style-type"] || "decimal" === a["list-style-type"]) && delete a["list-style-type"]
    };
