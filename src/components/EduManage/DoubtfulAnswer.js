    ...
    render() {
        ...
        if (this.state.photo) {
            this.state.photo.forEach((item, index) => {
                tempImg.push(
                    <div style={{margin: "0 0 20px 50px"}} key={index}>
                        <img src={item.photo} alt="" className="item-content"/>
                    </div>                    
                )
            })
        }
    ...
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                ...
                dataIndex: 'photo',
                width: '8%',
                render: (text, record) => (<img style={{width: '30px', height: "18px"}} src={record.photo} alt="" />)
            },
            {
                title: '提问时间',
                dataIndex: 'createTime',
