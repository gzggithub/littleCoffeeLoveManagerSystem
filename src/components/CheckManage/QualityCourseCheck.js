            ...
            >
                <div className="institutionCheck-form quality-course-check-form">
                    <Form layout="vertical">
                        <h4 className="add-form-title-h4">精品课程申请信息</h4>
                        <Row gutter={24}>
                            <Col span={8}>
        ...
        reqwest({
            ...
            success: (json) => {
                if (json.result === 0) {
                    ...
                    json.data.characteristic = this.removeTAG(json.data.characteristic)
                    this.setState({
                        data: json.data,
...
class QualityCourseCheck extends Component {
    constructor(props) {
        super(props);
        this.state = {
            type: "0",
...
export default QualityCourseCheck;