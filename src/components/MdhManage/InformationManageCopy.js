                ...
                <div className="institution-add institution-form item-form">
                    <Form layout="vertical">
                        ...
                        <Row gutter={24}>
                            ...
                            <Col span={8}>
                                <FormItem className="advPosition" label="成长位置：">
...
class ItemDetails extends Component {
    ...
    render() {
        ...
        if (this.state.data) {
            ...
            dataSource = [
                <div className="name">
                    <span className="item-name">成长名称：</span>
                ...
                <div className="description">
                    <span className="item-name">成长简介：</span>
                    <pre>
                ...
                <div className="mainEducation">
                    <span className="item-name">是否主成长：</span>
...
class InformationManageCopy extends Component {
    constructor(props) {
        super(props);
        this.state = {
            opObj: {},
...
export default InformationManageCopy;