...
const ItemCheckForm = Form.create()(
    (props) => {
        ...
        return (
            ...
            >
                <div className="newOneCheck-form">
                    <Form layout="vertical">
                        ...
                        <FormItem className={opinionClass} {...formItemLayout_14} label="审核意见：">
                            {getFieldDecorator('opinion', {
                                ...
                                <TextArea style={{resize: "none"}} placeholder="请填写审核意见（50字以内）" rows={3}/>
                            )}
                        </FormItem>
                    </Form>
                </div>
...
class ItemCheck extends Component {
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            reqwest({
                url: '/mdhRecommend/reviewRecommend',
                type: 'json',
                method: 'post',
                headers: {
                    Authorization: sessionStorage.token
...
class DataTable extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            pagination: {
                current: 1,
                pageSize: Number(localStorage.newsOneCheckSize) || 10,
                    ...
                    return (
                        <div className="editable-row-operations">
                            ...
                            <a onClick={() => this.props.setEdit("status", true, record.id)}
                               style={{display: record.state === 1 ? "inline" : "none"}}>编辑</a>
                            {/*资讯审核*/}
    ...
    handleTableChange = (pagination) => {
        ...
        localStorage.newsOneCheckSize = pagination.pageSize;
        pager.pageSize = Number(localStorage.newsOneCheckSize);
        this.setState({
            pagination: pager,
        }, () => {
            this.getData();
...
class NewsOneCheck extends Component {
    constructor(props) {
        super(props);
        this.state = {
            type: "1",
