...
const ItemAddForm = Form.create()(
    (props) => {
        const {visible, onCancel, onCreate, form, allTypeList, provinceList, cityList, area, setArea, reqwestUploadToken, photoList01, setPhotoList01, viewPic02, effectPic02, data_pic02, setViewPic02, picUpload02, avatarEditor02, setAvatarEditor02, logoLoading, confirmLoading} = props;
...
class ItemAdd extends Component {
    ...
    handleCreate = () => {
        ...
        form.validateFieldsAndScroll((err, values) => {
            ...
            values.photo = this.state.data_pic02;
            if (!values.photo) {
                message.error("广告图片未提交");
                return
            }
            
            // if (!this.state.area.city) {
                                    ...
                                    <Col span={8}>
                                        <FormItem className="advPositionIds" label="广告位置：">
                                            {getFieldDecorator('type', {
                                                ...
                                                >
                                                    {/* {optionsOfTypeList}*/}
                                                    <Option key={1} value={1}>首页banner广告</Option>
                                                    <Option key={2} value={2}>育儿栏目banner广告</Option>
                                                    <Option key={3} value={3}>首页banner广告1</Option>
                                                    <Option key={4} value={4}>首页banner广告2</Option>
                                                </Select>
                                            )}
                                        </FormItem>
                                    </Col>
                        ...
                        <div>
                            <header className="clearfix">
                                ...
                                <div className="add-button" style={{float: "right"}}>
                                    <ItemAdd opStatus={this.state.opObj.add} recapture={this.getData} toLoginPage={this.toLoginPage}/>
                                </div>
                            </header>
                            {/*广告列表*/}
