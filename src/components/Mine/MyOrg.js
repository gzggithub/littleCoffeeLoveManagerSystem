...
const ItemEditForm = Form.create()(
    (props) => {
        const {allTypeList, typeList, onChange, handleSearch, handleChange, checkPhone, checkTel, editCompany, readlyOnly, onCancel, onCreate, setPhone, form, data, reqwestUploadToken, viewPic01, setViewPic01, picUpload01, photoList01, setPhotoList01, avatarEditor01, setAvatarEditor01, photoLoading, viewPic02, setViewPic02, data_pic02, effectPic02, picUpload02, avatarEditor02, setAvatarEditor02, logoLoading, provinceList, cityList, districtList, streetList, markers, setMarkers, area, setArea, mapObj, setXY, setFormattedAddress, formattedAddress, detailedAddress} = props;
        ...
        const picHandle02 = () => {
            // if (viewPic02 && viewPic02.slice(global.config.photoUrl.length) !== data_pic02) {
            if (viewPic02 && viewPic02 !== data_pic02) {
                    ...
                    if (status_ === 'complete' && result_.info === 'OK') {
                        geocoder.getAddress([result_.geocodes[0].location.lng, result_.geocodes[0].location.lat], (status, result) => {
                            if (status === 'complete' && result.info === 'OK') {
                                // 经纬度写入
                                console.log(54545545454)
                                console.log(result_.geocodes[0].location.lng);
                                console.log(result_.geocodes[0].location.lat);
        ...
        // 使用 initialValue: data.label[0] 特色标签初始化有问题，先修改如下
        let label_01 = '';
        let label_02 = '';
        let label_03 = '';
        let label_04 = '';
        ...
        let label_06 = '';
        if (data.label) {
            label_01 = data.label[0];
            label_02 = data.label[1];
            label_03 = data.label[2];
            label_04 = data.label[3];
            label_05 = data.label[4];
            label_06 = data.label[5];
        }
        return ( 
            <div>
                <header className="clearfix">
                    ...
                    <div className="add-button" style={{float: "right"}}>
                        <Button 
                            type="primary" 
                            onClick={editCompany}
                            style={{display: true ? "inline" : "none", marginRight: 20}}>编辑</Button>
                    </div>
                </header>
                            ...
                            <Col span={8}>
                                <FormItem className="name"  label="机构名称：">
                                    {getFieldDecorator('name', {
                                        ...
                                        <Input disabled={readlyOnly} placeholder="请输入机构名称"/>
                                    )}
                                </FormItem>
                                            ...
                                            <Row>
                                                ...
                                                <Col span={12}>
                                                    <Slider 
                                                        ...
                                                        max={1.5} 
                                                        step={0.01} 
                                                        value={avatarEditor01.scale}
                                                        disabled={!viewPic01 && readlyOnly}
                                                        onChange={(value) => {
                                            ...
                                            <Row>
                                                ...
                                                <Col span={12}>
                                                    <Slider 
                                                        ...
                                                        max={1} 
                                                        step={0.01} 
                                                        value={avatarEditor01.positionX}
                                                        disabled={!viewPic01 && readlyOnly}
                                                        onChange={(value) => {
                                            ...
                                            <Row>
                                                ...
                                                <Col span={12}>
                                                    <Slider 
                                                        ...
                                                        max={1} 
                                                        step={0.01} 
                                                        value={avatarEditor01.positionY}
                                                        disabled={!viewPic01 && readlyOnly}
                                                        onChange={(value) => {
                                ...
                                <FormItem className="name" label="营业时间：">
                                    {getFieldDecorator('businessHours', {
                                        ...
                                        rules: [
                                            ...
                                            {
                                                max: 100,
                                                message: '营业时间不能超过100字'
                                            }
                                        ],
                                    })(
                                        <Input disabled={readlyOnly} placeholder="请填写营业时间"/>
                                    )}
                                </FormItem>
                            </Col>
                            <Col span={8}>
                                    ...
                                    <Col span={4}>
                                        <FormItem className="label_01" label="特色标签：">
                                            {getFieldDecorator('label_01', {
                                                ...
                                                <Input disabled={readlyOnly} placeholder="如：小班教学"/>     
                                            )}
                                        </FormItem>
                                    </Col>
                                    <Col span={4}>
                                        <FormItem className="label_02" label="">
                                            {getFieldDecorator('label_02', {
                                                ...
                                                <Input disabled={readlyOnly} style={{marginTop: "31px"}} placeholder="如：免费WiFi"/> 
                                    ...
                                    <Col span={4}>
                                        <FormItem className="label_03" label="">
                                            {getFieldDecorator('label_03', {
                                                ...
                                                <Input disabled={readlyOnly} style={{marginTop: "31px"}}  placeholder="如：一对一"/>     
                                            )}
                                        </FormItem>
                                    </Col>
                                    <Col span={4}>
                                        <FormItem className="label_04" label="">
                                            {getFieldDecorator('label_04', {
                                                ...
                                                <Input disabled={readlyOnly} style={{marginTop: "31px"}}  placeholder="如：夏令营"/>     
                                            )}
                                        </FormItem>
                                    </Col>
                                    <Col span={4}>
                                        <FormItem className="label_05" label="">
                                            {getFieldDecorator('label_05', {
                                                ...
                                                <Input disabled={readlyOnly} style={{marginTop: "31px"}} placeholder="如：主题活动"/>     
                                            )}
                                        </FormItem>
                                    </Col>
                                    <Col span={4}>
                                        <FormItem className="label_06" label="">
                                            {getFieldDecorator('label_06', {
                                                ...
                                                <Input disabled={readlyOnly} style={{marginTop: "31px"}} placeholder="如：生日会"/>     
                                            )}
                                        </FormItem>
                                    </Col>
                                    <div  style={{position: 'absolute', top: 6, right: 20}}>
                                            ...
                                            <Row>
                                                ...
                                                <Col span={12}>
                                                    <Slider 
                                                        ...
                                                        disabled={(viewPic02 ? true : false) && readlyOnly}
                                                        onChange={(value) => {
                            ...
                            <Col span={14}>
                                ...
                                <Row>
                                    <Col>
                                        ...
                                        <div id="add-institution-container-mine-0" style={{width: '100%', height: '320px', marginBottom: '10px'}} name="container" tabIndex="0"/>
                                    </Col>
                                </Row>
                            </Col>
                        </Row>
                            ...
                            <Col span={8}>
                                <FormItem className="companyName" label="企业名称：">
                                    {getFieldDecorator('companyName', {
                                        ...
                                        <Input disabled={readlyOnly} placeholder="请输入企业名称"/>
                                    )}
                                </FormItem>
                            </Col>
                            <Col span={8}>
...
class ItemEdit extends Component {
            ...
            success: (json) => {
                if (json.result === 0) {                    
                    ...
                    if (json.data.orgResourceList) {
                        photoList01 = json.data.orgResourceList.filter(fnFilter01);
                    ...
                    console.log(typeof(json.data.org.provinceId))
                    console.log(typeof(json.data.org.cityId))
                    this.setState({
                        data: json.data.org,
                        ...
                        // 机构地址相关操作
                        const mapId = "add-institution-container-mine-0";
                        this.setState({
    ...
    handleCreate = () => {
        ...
        form.validateFieldsAndScroll((err, values) => {
            ...
            console.log(this.state.data_pic02);
            // 机构Logo修改校验
    ...
    countDownTip = () => {
        ...
        const modal = Modal.success({
            title: `友情提示`,
            content: `修改机构成功，正在返回，请稍后 ${secondsToGo} s.`,
        });
            ...
            this.setState({
                ...
                this.state.mapObj.on('complete', () => {
                    ...
                    window.AMap.service('AMap.Geocoder', () => {
                        ...
                        console.log("componentWillMount----4444-")
                        this.state.mapObj.on('click', (e) => {
                            // 清除已有标记点
                            this.state.mapObj.remove(this.state.markers);
                            ...
                            console.log("componentWillMount-----5555")
                            console.log(this.state.mapObj)
                            // 生成当前标记点
                            const marker = new window.AMap.Marker({
                                map: this.state.mapObj,
