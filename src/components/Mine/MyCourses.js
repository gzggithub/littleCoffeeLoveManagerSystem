            ...
            >
                <div className="course-add course-form item-form">
                    <Form layout="vertical">
                        ...
                        <div className="ant-line"></div>
                        <FormItem
                            className={institutionOptions.length >= 1 ? "orgIds longItem unnecessary" : "orgIds longItem unnecessary itemNone"} label="将课程信息同步到如下分机构：">
        ...
        reqwest({
            ...
            success: (json) => {
                ...
                if (json.result === 0) {
                    ...
                    coursorgId = Math.max.apply(null, dataCoursesId);
                    console.log(coursorgId);
                    this.getData(coursorgId);
                    this.setState({
                        loading: false,
                    })
                } else {
    ...
    render() {
        return (
            <div style={{display: this.props.opStatus ? "block" : "none"}}>
                <Button
                    style={{display: this.props.opStatus.copy ? "inline" : "none"}}
                    onClick={this.copyCourse.bind(this, "1")}>复制课程</Button>
                <Button
                    style={{display: this.props.opStatus.add ? "inline" : "none", marginLeft: 10}}
                    type="primary"
        ...
        if (this.state.data) {
            ...
            dataSource = [
                ...
                <div className="soldQuantity">
                    ...
                    <span
                        className="item-content">{this.state.data.soldQuantity || "0"}</span>
                </div>,
                <div className="visitorNum">
                    <span className="item-name">访问量：</span>
                    <span
                        className="item-content">{this.state.data.visitorNum || "0"}</span>
                </div>,
                                ...
                                <header className="clearfix" style={{position: "relative"}}>                                    
                                    <div>
                                        ...
                                        <Search
                                            ...
                                            enterButton
                                            style={{
                                                // display: Number(sessionStorage.orgId) !== 0 ? "block" : "none",
                                                width: "320px",
                                                float: "left"
                                            }}
                                        />
