        ...
        return (
            <div style={{display: this.props.opStatus ? "block" : "none"}}>
                <Button 
                    ...
                    onClick={this.copyTeacher.bind(this, "1")}>复制教师</Button>
                <Button
                    ...
                    JSON.stringify(data) === "{}" ?
                        ...
                        <div className="teacher-edit teacher-form item-form">
                            <Form layout="vertical">
                                ...
                                <Row gutter={24}>
                                    <Col span={8}>
                                        <FormItem className="principal" label="主攻方向：">
                                            {getFieldDecorator('principal', {
                                    ...
                                    <Col span={8}>
                                        <FormItem className="teachingIdea" label="教学理念：">
                                            {getFieldDecorator('teachingIdea', {
                                ...
                                <Row gutter={24}>
                                    <Col>
                                        <FormItem className="courseIds" label="">
                                            {getFieldDecorator('courseIds', {
                                                initialValue: courseIds,
                                                rules: [
                                                    {
...
class ItemEdit extends Component {
    ...
    // 设置图片缩放比例及偏移量
    setAvatarEditor = (index, value) => {
        if (this.state.viewPic.slice(global.config.photoUrl.length) === this.state.data_pic) {
