                ...
                tempVideoList.push(
                    <Col span={8} key={index+1}>
                        <div className="videoCol">
                            ...
                            <input className="videoCourseName" disabled={item.readOnly} onChange={(e) => onChangeCourseName(e.target.value, index)} defaultValue={item.name} placeholder="请输入通告名称"/>                       
